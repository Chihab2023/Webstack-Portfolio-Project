...
function get_locale() {
	...
	/**
	 * Filters the locale ID of the projectpilot installation.
	 *
	 * @since 1.5.0
	 *
 ...
 *
 * Loads the .mo file in WP_LANG_DIR constant path from projectpilot root.
 ...
 * @since 4.7.0
 *
 * @global WP_Locale_Switcher $wp_locale_switcher projectpilot locale switcher object.
 *
 * @param string $locale The locale.
 * @return bool True on success, false on failure.
 */
