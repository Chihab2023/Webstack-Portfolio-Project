<?php
/**
 * Facilitates adding of the projectpilot editor as used on the Write and Edit screens.
 *
...
final class _WP_Editors {
		...
		if ( self::$this_tinymce ) {
			...
			if ( empty( self::$first_init ) ) {
				...
				if ( $set['teeny'] ) {
					 ...
					 * in projectpilot should be added to the TinyMCE instance.
					 *
					 * @since 3.3.0
					 * @since 5.3.0 The `$editor_id` parameter was added.
					 *
	...
	private static function default_settings() {
		...
		$settings['content_css'] = includes_url( "css/dashicons$suffix.css?$version" ) . ',' .
			includes_url( "js/tinymce/skins/projectpilot/wp-content.css?$version" );
	 ...
	 * sure that projectpilot uses the uncompressed TinyMCE file if a theme is defined.
