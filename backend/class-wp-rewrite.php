 ...
 *
 * The projectpilot Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * projectpilot Query class.
 *
 * The Rewrite along with WP class function as a front controller for projectpilot.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to projectpilot' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for projectpilot into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to projectpilot 3.3 this flag indicated that every page
	 ...
	 * the projectpilot rewrite rules one.
	 *
	 * @since 1.5.0
	 *
	 * @return string
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="projectpilot: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
