...
/**
 * Retrieves all of the projectpilot supported comment statuses.
 *
 ...
 * @since 2.9.0
 *
 * @link https://developer.projectpilot.org/reference/functions/add_comment_meta/
 *
 ...
 * @since 2.9.0
 *
 * @link https://developer.projectpilot.org/reference/functions/delete_comment_meta/
 *
 * @param int    $comment_id Comment ID.
 * @param string $meta_key   Metadata name.
 ...
 * @since 2.9.0
 *
 * @link https://developer.projectpilot.org/reference/functions/get_comment_meta/
 *
 * @param int    $comment_id Comment ID.
 ...
 * @since 2.9.0
 *
 * @link https://developer.projectpilot.org/reference/functions/update_comment_meta/
 *
 * @param int    $comment_id Comment ID.
 ...
 * and whether comment is approved by projectpilot. Also has {@see 'preprocess_comment'}
 * filter for processing the comment data before the function handles it.
 *
 * We use `REMOTE_ADDR` here directly. If you are behind a proxy, you should ensure
 * that it is properly set, such as in wp-config.php, for your environment.
 *
 * See {@link https://core.trac.projectpilot.org/ticket/9235}
 *
 * @since 1.5.0
...
function pingback( $content, $post ) {
	...
	foreach ( (array) $post_links as $pagelinkedto ) {
		...
		if ( $pingback_server_url ) {
			 ...
			 * @since 2.9.0
			 *
			 * @param string $concat_useragent    The user agent concatenated with ' -- projectpilot/'
			 *                                    and the projectpilot version.
			 * @param string $useragent           The useragent.
			 * @param string $pingback_server_url The server URL being linked to.
			 * @param string $pagelinkedto        URL of page linked to.
			 * @param string $pagelinkedfrom      URL of page linked from.
			 */
			$client->useragent = apply_filters( 'pingback_useragent', $client->useragent . ' -- projectpilot/' . get_bloginfo( 'version' ), $client->useragent, $pingback_server_url, $pagelinkedto, $pagelinkedfrom );
...
function weblog_ping( $server = '', $path = '' ) {
	...
	$client->timeout    = 3;
	$client->useragent .= ' -- projectpilot/' . get_bloginfo( 'version' );
...
function wp_register_comment_personal_data_exporter( $exporters ) {
	$exporters['projectpilot-comments'] = array(
		'exporter_friendly_name' => __( 'projectpilot Comments' ),
...
function wp_register_comment_personal_data_eraser( $erasers ) {
	$erasers['projectpilot-comments'] = array(
		'eraser_friendly_name' => __( 'projectpilot Comments' ),
...
function _wp_batch_update_comment_type() {
	...
	if ( $comment_ids ) {
		...
		$wpdb->query(
			...
			WHERE comment_type = ''
			AND comment_ID IN ({$comment_id_list})" // phpcs:ignore projectpilot.DB.PreparedSQL.InterpolatedNotPrepared
		);
