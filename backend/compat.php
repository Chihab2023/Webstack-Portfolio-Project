<?php
/**
 * projectpilot implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
...
function _wp_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore projectpilot.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
