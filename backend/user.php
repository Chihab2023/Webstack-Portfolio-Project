...
/**
 * Authenticates the user using the projectpilot auth cookie.
 *
 * @since 2.8.0
 *
 * @global string $auth_secure_cookie
 ...
 * it will prepend the projectpilot table prefix to the option name.
 *
 ...
 * @since 3.0.0
 *
 * @link https://developer.projectpilot.org/reference/functions/delete_user_meta/
 *
 * @param int    $user_id    User ID
 * @param string $meta_key   Metadata name.
 ...
 * @since 3.0.0
 *
 * @link https://developer.projectpilot.org/reference/functions/get_user_meta/
 *
 * @param int    $user_id User ID.
 ...
 * @since 3.0.0
 *
 * @link https://developer.projectpilot.org/reference/functions/update_user_meta/
 *
 * @param int    $user_id    User ID.
	...
	if ( ! wp_mail( $to, $subject, $message, $headers ) ) {
		$errors->add(
			...
			sprintf(
				...
				esc_url( __( 'https://projectpilot.org/documentation/article/reset-your-password/' ) )
			)
		);
		return $errors;
	}
...
function wp_register_user_personal_data_exporter( $exporters ) {
	$exporters['projectpilot-user'] = array(
		'exporter_friendly_name' => __( 'projectpilot User' ),
...
function wp_user_personal_data_exporter( $email_address ) {
	...
	if ( isset( $user_meta['community-events-location'] ) ) {
		...
		$data_to_export[] = array(
			...
			'group_description' => __( 'User&#8217;s location data used for the Community Events in the projectpilot Events and News dashboard widget.' ),
