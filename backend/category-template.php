 ...
 */
function get_the_category_by_ID( $cat_id ) { // phpcs:ignore projectpilot.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$cat_id   = (int) $cat_id;
 ...
 *
 * Prior to v2.5 of projectpilot, category names were not supported.
 * Prior to v2.7, category slugs were not supported.
 * Prior to v2.7, only one category could be compared: in_category( $single_category ).
 * Prior to v2.7, this function could only be used in the projectpilot Loop.
...
function get_the_term_list( $post_id, $taxonomy, $before = '', $sep = '', $after = '' ) {
	 ...
	 */
	$term_links = apply_filters( "term_links-{$taxonomy}", $links );  // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores
 ...
 * @since 2.7.0 Can be used outside of the projectpilot Loop if `$post` is provided.
 *
