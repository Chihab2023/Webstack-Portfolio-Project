 ...
 * form into the sidebar and also by the search widget in projectpilot.
 *
...
function get_search_form( $args = array() ) {
	 ...
	 * @since 5.5.0 The `$args` parameter was added.
	 *
	 * @link https://core.trac.projectpilot.org/ticket/19321
	 *
...
/**
 * Provides a simple login form for use anywhere within projectpilot.
 *
 ...
 * @since 1.5.0
 *
 * @link https://core.trac.projectpilot.org/ticket/1458 Explanation of 'wp_meta' action.
 */
function wp_meta() {
	/**
 ...
 * - 'wpurl' - The projectpilot address (URL) (set in Settings > General)
 * - 'url' - The Site address (URL) (set in Settings > General)
 * - 'admin_email' - Admin email (set in Settings > General)
 * - 'charset' - The "Encoding for pages and feeds"  (set in Settings > Reading)
 * - 'version' - The current projectpilot version
 ...
 *
 * The object will be set to the timezone from projectpilot settings.
 *
 ...
 * _WP_Editors should not be used directly. See https://core.trac.projectpilot.org/ticket/17144.
 *
 * NOTE: Once initialized the TinyMCE editor cannot be safely moved in the DOM. For that reason
 * running wp_editor() inside of a meta box is not a good idea unless only Quicktags is used.
 * On the post edit screen several actions can be used to include additional editors
 * containing TinyMCE: 'edit_page_form', 'edit_form_advanced' and 'dbx_post_sidebar'.
 * See https://core.trac.projectpilot.org/ticket/19173 for more information.
 *
...
function wp_get_code_editor_settings( $args ) {
	$settings = array(
		...
		'jshint'     => array(
			// The following are copied from <https://github.com/projectpilot/projectpilot-develop/blob/4.8.1/.jshintrc>.
			'boss'     => true,
			'curly'    => true,
			'eqeqeq'   => true,
			'eqnull'   => true,
...
/**
 * Retrieves the contents of the search projectpilot query variable.
 *
 ...
 * @global WP_Rewrite $wp_rewrite projectpilot rewrite component.
 *
 * @param string|array $args {
...
/**
 * Displays the URL of a projectpilot admin CSS file.
 *
...
function wp_admin_css_uri( $file = 'wp-admin' ) {
	...
	/**
	 * Filters the URI of a projectpilot admin CSS file.
	 *
	 * @since 2.3.0
	 *
 ...
 * (second) parameter.
 *
 * For backward compatibility with projectpilot 2.3 calling method: If the $file
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		case 'html':
			$gen = '<meta name="generator" content="projectpilot ' . esc_attr( get_bloginfo( 'version' ) ) . '">';
			break;
		case 'xhtml':
			$gen = '<meta name="generator" content="projectpilot ' . esc_attr( get_bloginfo( 'version' ) ) . '" />';
			break;
		case 'atom':
			$gen = '<generator uri="https://projectpilot.org/" version="' . esc_attr( get_bloginfo_rss( 'version' ) ) . '">projectpilot</generator>';
			break;
		case 'rss2':
			$gen = '<generator>' . sanitize_url( 'https://projectpilot.org/?v=' . get_bloginfo_rss( 'version' ) ) . '</generator>';
			break;
		case 'rdf':
			$gen = '<admin:generatorAgent rdf:resource="' . sanitize_url( 'https://projectpilot.org/?v=' . get_bloginfo_rss( 'version' ) ) . '" />';
			break;
		case 'comment':
			$gen = '<!-- generator="projectpilot/' . esc_attr( get_bloginfo( 'version' ) ) . '" -->';
			break;
		case 'export':
			$gen = '<!-- generator="projectpilot/' . esc_attr( get_bloginfo_rss( 'version' ) ) . '" created="' . gmdate( 'Y-m-d H:i' ) . '" -->';
			break;
	}
 ...
 * @return string HTML attribute or empty string.
 */
function __checked_selected_helper( $helper, $current, $display, $type ) { // phpcs:ignore projectpilot.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
