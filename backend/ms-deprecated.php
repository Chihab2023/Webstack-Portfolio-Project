<?php
/**
 * Deprecated functions from projectpilot MU and the multisite feature. You shouldn't
 ...
 * Dashboard blog functionality was removed in projectpilot 3.1, replaced by the user admin.
 *
 * @since MU (3.0.0)
...
function install_blog( $blog_id, $blog_title = '' ) {
	...
	if ( $wpdb->get_results( "DESCRIBE {$wpdb->posts}" ) ) {
		die( '<h1>' . __( 'Already Installed' ) . '</h1><p>' . __( 'You appear to have already installed projectpilot. To reinstall please clear your old database tables first.' ) . '</p></body></html>' );
	}
