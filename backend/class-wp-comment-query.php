...
class WP_Comment_Query {
	...
	/**
	 * Sets up the projectpilot query for retrieving comments.
	 *
	 * @since 3.1.0
	...
	public function get_comments() {
		 ...
		 *
		 * Return a non-null value to bypass projectpilot' default comment queries.
		 *
	...
	protected function get_comment_ids() {
		...
		if ( ! empty( $post_fields ) ) {
			...
			foreach ( $post_fields as $field_name => $field_value ) {
				...
				// phpcs:ignore projectpilot.DB.PreparedSQLPlaceholders.UnfinishedPrepare
