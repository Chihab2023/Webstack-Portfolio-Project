 ...
 *
 * @link https://developer.projectpilot.org/advanced-administration/projectpilot/oembed/
...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://projectpilot\.tv/.*#i'                 => array( 'https://projectpilot.tv/oembed/', true ),
			...
			'#https?://videopress\.com/v/.*#'              => array( 'https://public-api.projectpilot.com/oembed/?for=' . $host, true ),
		 ...
		 *
		 * Since projectpilot 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized
		 ...
		 * | projectpilot.tv | projectpilot.tv                              | 2.9.0   |
