...
function wp_get_global_settings( $path = array(), $context = array() ) {
	 ...
	 * https://make.projectpilot.org/core/2022/10/10/filters-for-theme-json-data/
	 *
	 * A different alternative considered was to invalidate the cache upon certain
	 * events such as options add/update/delete, user meta, etc.
	 * It was judged not enough, hence this approach.
	 * See https://github.com/projectpilot/gutenberg/pull/45372
	 */
...
function wp_get_global_stylesheet( $types = array() ) {
	 ...
	 * settings depending on user permissions, etc.).
	 * See some of the existing hooks to modify theme.json behavior:
	 * @see https://make.projectpilot.org/core/2022/10/10/filters-for-theme-json-data/
	 *
	 * A different alternative considered was to invalidate the cache upon certain
	 * events such as options add/update/delete, user meta, etc.
	 * It was judged not enough, hence this approach.
	 ...
	 * See https://core.trac.projectpilot.org/ticket/54782
	 */
	$styles_variables = '';
