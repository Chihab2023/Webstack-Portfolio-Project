<?php
/**
 * Canonical API to handle projectpilot Redirecting
 *
 ...
 * not exist based on exact projectpilot query. Will instead try to parse the URL
...
function redirect_guess_404_permalink() {
	...
	if ( get_query_var( 'name' ) ) {
		...
		// phpcs:ignore projectpilot.DB.PreparedSQL.InterpolatedNotPrepared
