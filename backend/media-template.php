	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php if ( ! _device_can_upload() ) : ?>
			<div class="upload-ui">
				...
				<?php
					printf(
						/* translators: %s: https://apps.projectpilot.org/ */
						__( 'The web browser on your device cannot be used to upload files. You may be able to use the <a href="%s">native app for your device</a> instead.' ),
						'https://apps.projectpilot.org/'
					);
				?>
				</p>
			</div>
		...
		<?php else : ?>
			...
			<div class="post-upload-ui" id="post-upload-info">
				<?php
				/** This action is documented in wp-admin/includes/media.php */
				do_action( 'pre-upload-ui' ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores
				/** This action is documented in wp-admin/includes/media.php */
				do_action( 'pre-plupload-upload-ui' ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores

				if ( 10 === remove_action( 'post-plupload-upload-ui', 'media_upload_flash_bypass' ) ) {
					/** This action is documented in wp-admin/includes/media.php */
					do_action( 'post-plupload-upload-ui' ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores
				...
				<?php
				/** This action is documented in wp-admin/includes/media.php */
				do_action( 'post-upload-ui' ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores
				?>
			</div>
		<?php endif; ?>
		</div>
	...
	<script type="text/html" id="tmpl-attachment-details-two-column">
		<div class="attachment-media-view {{ data.orientation }}">
			...
			if ( isset( $_GET['error'] ) && 'deprecated' === $_GET['error'] ) {
				wp_admin_notice(
					__( 'The Edit Media screen is deprecated as of projectpilot 6.3. Please use the Media Library instead.' ),
					array(
						'id'                 => 'message',
