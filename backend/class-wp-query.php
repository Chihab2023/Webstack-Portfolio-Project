...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info projectpilot was able to figure out.
	 *
	 * @since 2.0.0
	 */
	...
	public function get_posts() {
		 ...
		 *
		 * See https://core.trac.projectpilot.org/ticket/56841.
		 * See https://github.com/projectpilot/projectpilot-develop/pull/6393#issuecomment-2088217429
		 */
		$old_request =
		 ...
		 *
		 * Return a non-null value to bypass projectpilot' default post queries.
		 *
		...
		if ( null === $this->posts ) {
			...
			if ( $split_the_query ) {
				...
				// Beginning of the string is on a new line to prevent leading whitespace. See https://core.trac.projectpilot.org/ticket/56841.
				$this->request =
	...
	/**
	 * Sets up the projectpilot query by parsing query string.
	 *
	 * @since 1.5.0
	 *
	 ...
	 * Constructor.
	 *
	 * Sets up the projectpilot query, if parameter is not empty.
	 *
	 * @since 1.5.0
	 *
	 * @see WP_Query::parse_query() for all available arguments.
	 ...
	 * @since 3.3.0
	 *
	 * @global WP_Query $wp_the_query projectpilot Query object.
	 *
