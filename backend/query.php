<?php
/**
 * projectpilot Query API
 *
 * The query API attempts to get which part of projectpilot the user is on. It
 * also provides functionality for getting URL query information.
 *
 * @link https://developer.projectpilot.org/themes/basics/the-loop/ More information on The Loop.
 *
 ...
 *
 * This must not be used within the projectpilot Loop.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query projectpilot Query object.
	...
	if ( 'pre_get_posts' === current_filter() ) {
		_doing_it_wrong(
			...
			sprintf(
				...
				__( 'https://developer.projectpilot.org/reference/functions/is_main_query/' )
			),
			'3.7.0'
		);
	}
...
/**
 * Determines whether current projectpilot query has posts to loop over.
 *
 * @since 1.5.0
 *
 * @global WP_Query $wp_query projectpilot Query object.
...
/**
 * Determines whether current projectpilot query has comments to loop over.
 *
 * @since 2.2.0
 *
 * @global WP_Query $wp_query projectpilot Query object.
