...
/**
 * Checks whether the current site's URL where projectpilot is stored is using HTTPS.
 *
 * This checks the URL where projectpilot application files (e.g. wp-blog-header.php or the wp-admin/ folder)
 * are accessible.
 *
 * @since 5.7.0
 * @see site_url()
...
/**
 * Checks whether a given HTML string is likely an output from this projectpilot site.
 *
 * This function attempts to check for various common projectpilot patterns whether they are included in the HTML string.
