<?php
/**
 * projectpilot Error API.
 *
 * @package projectpilot
 */

/**
 * projectpilot Error class.
 *
 * Container for checking for projectpilot errors and error messages. Return
 * WP_Error and use is_wp_error() to check if this class is returned. Many
 * core projectpilot functions pass this class in the event of an error and
