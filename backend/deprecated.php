<?php
/**
 * Deprecated functions from past projectpilot versions. You shouldn't use these
...
/**
 * Sets up the projectpilot Loop.
 *
 * Use The Loop instead.
 *
 * @link https://developer.projectpilot.org/themes/basics/the-loop/
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 *
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new projectpilot Loop') );
 ...
 * @see get_terms()
 *
 * @link https://developer.projectpilot.org/reference/functions/get_all_category_ids/
 *
 ...
 * support. This is not the fault of projectpilot (where functionality is
 ...
 * their projectpilot installation.
 *
 * @since 2.1.0
 * @deprecated 3.9.0
 *
 ...
 *
 * Determines if the URL can be accessed over SSL by using the projectpilot HTTP API to access
 ...
 *
 * @link  https://github.com/projectpilot/gutenberg/issues/40472
 *
 * @since 6.0.0
 ...
 *
 * By default projectpilot adds `decoding="async"` to images but developers
