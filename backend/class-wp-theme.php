...
final class WP_Theme implements ArrayAccess {
	...
	private static $default_themes = array(
		'classic'           => 'projectpilot Classic',
		'default'           => 'projectpilot Default',
	 ...
	 * get_template() takes into account where projectpilot actually located the theme and
	...
	private function translate_header( $header, $value ) {
		switch ( $header ) {
			case 'Name':
				...
				// phpcs:ignore projectpilot.WP.I18n.LowLevelTranslationFunction,projectpilot.WP.I18n.NonSingularStringLiteralText,projectpilot.WP.I18n.NonSingularStringLiteralDomain
	...
	/**
	 * Determines the latest projectpilot default theme that is installed.
	 *
