 ...
 *
 * These functions are meant to live inside of the projectpilot loop.
 *
 ...
 */
function get_comment_author_IP( $comment_id = 0 ) { // phpcs:ignore projectpilot.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$comment = get_comment( $comment_id );
	 ...
	 * @param WP_Comment $comment           The comment object.
	 */
	return apply_filters( 'get_comment_author_IP', $comment->comment_author_IP, $comment->comment_ID, $comment );  // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
}
 ...
 *                                   Default current comment.
 */
function comment_author_IP( $comment_id = 0 ) { // phpcs:ignore projectpilot.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function get_comment_ID() { // phpcs:ignore projectpilot.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$comment = get_comment();
	 ...
	 * @param WP_Comment $comment    The comment object.
	 */
	return apply_filters( 'get_comment_ID', $comment_id, $comment );  // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
}
 ...
 * @since 0.71
 */
function comment_ID() { // phpcs:ignore projectpilot.NamingConventions.ValidFunctionName.FunctionNameInvalid
	echo get_comment_ID();
}
 ...
 *
 * Uses the projectpilot database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the projectpilot process will be
 ...
 *           comment. See https://core.trac.projectpilot.org/changeset/36512.
 *
 * @since 2.7.0
 * @since 6.2.0 Added the `$post` parameter.
 *
