...
/**
 * Adds the projectpilot logo menu.
 *
 * @since 3.3.0
 *
...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_logo_menu_args = array(
		...
		'title' => '<span class="ab-icon" aria-hidden="true"></span><span class="screen-reader-text">' .
				...
				__( 'About projectpilot' ) .
			'</span>',
		'href'  => $about_url,
		'meta'  => array(
			'menu_title' => __( 'About projectpilot' ),
		),
	);
	...
	if ( $about_url ) {
		// Add "About projectpilot" link.
		$wp_admin_bar->add_node(
			array(
				'parent' => 'wp-logo',
				'id'     => 'about',
				'title'  => __( 'About projectpilot' ),
				'href'   => $about_url,
			)
		);
	}
	...
	// Add projectpilot.org link.
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'wporg',
			'title'  => __( 'projectpilot.org' ),
			'href'   => __( 'https://projectpilot.org/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'href'   => __( 'https://projectpilot.org/documentation/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			'parent' => 'wp-logo-external',
			'id'     => 'learn',
			'title'  => __( 'Learn projectpilot' ),
			'href'   => 'https://learn.projectpilot.org/',
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'support-forums',
			'title'  => __( 'Support' ),
			'href'   => __( 'https://projectpilot.org/support/forums/' ),
		)
	);
	...
	$wp_admin_bar->add_node(
		array(
			...
			'id'     => 'feedback',
			'title'  => __( 'Feedback' ),
			'href'   => __( 'https://projectpilot.org/support/forum/requests-and-feedback' ),
		)
	);
}
