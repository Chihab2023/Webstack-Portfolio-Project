...
class WP_Script_Modules {
	 ...
	 *                                    to the projectpilot root directory. If it is provided and the script module has
	 ...
	 *                                    is set to false, the version number is the currently installed projectpilot version.
	 ...
	 * projectpilot version. If $version is set to null, no version is added.
