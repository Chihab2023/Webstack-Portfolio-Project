<?php
/**
 * projectpilot scripts and styles default loader.
 *
...
/** projectpilot Dependency Class */
require ABSPATH . WPINC . '/class-wp-dependency.php';

/** projectpilot Dependencies Class */
require ABSPATH . WPINC . '/class-wp-dependencies.php';

/** projectpilot Scripts Class */
require ABSPATH . WPINC . '/class-wp-scripts.php';

/** projectpilot Scripts Functions */
require ABSPATH . WPINC . '/functions.wp-scripts.php';

/** projectpilot Styles Class */
require ABSPATH . WPINC . '/class-wp-styles.php';

/** projectpilot Styles Functions */
...
/**
 * Registers all the projectpilot vendor scripts that are in the standardized
...
/**
 * Registers development scripts that integrate with `@projectpilot/scripts`.
 *
 * @see https://github.com/projectpilot/gutenberg/tree/trunk/packages/scripts#start
 *
 * @since 6.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all the projectpilot packages scripts that are in the standardized
 * `js/dist/` location.
 *
 * For the order of `$scripts->add` see `wp_default_scripts`.
 *
...
function wp_default_packages_scripts( $scripts ) {
	...
	foreach ( $assets as $file_name => $package_data ) {
		 ...
		 * because projectpilot prints a script's translations *before* the script,
...
/**
 * Adds inline scripts required for the projectpilot JavaScript packages.
 *
 * @since 5.0.0
...
function wp_default_packages_inline_scripts( $scripts ) {
	 ...
	 * For more context, see https://github.com/projectpilot/gutenberg/issues/33203.
	 */
	$scripts->add_inline_script(
		'wp-editor',
...
/**
 * Registers all the projectpilot packages scripts.
 *
 * @since 5.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all projectpilot scripts.
 *
...
function wp_default_scripts( $scripts ) {
	...
	// projectpilot no longer uses or bundles Prototype or script.aculo.us. These are now pulled from an external source.
	...
	did_action( 'init' ) && $scripts->localize(
		...
		array(
			...
			'blockThemeNotification'  => sprintf(
				...
				__( 'https://projectpilot.org/documentation/article/site-editor/' ),
				sprintf(
	...
	if ( is_admin() ) {
		 ...
		 * see https://core.trac.projectpilot.org/ticket/42321
		 */
...
function wp_enqueue_global_styles() {
	 ...
	 *
	 * See https://core.trac.projectpilot.org/ticket/53494.
	 */
	if (
...
/**
 * Makes URLs relative to the projectpilot installation.
 *
 * @since 5.9.0
 * @access private
 *
 * @param string $css            The CSS to make URLs relative to the projectpilot installation.
 * @param string $stylesheet_url The URL to the stylesheet.
 *
 * @return string The CSS with URLs made relative to the projectpilot installation.
 */
 ...
 *
 * @link https://core.trac.projectpilot.org/ticket/53494.
 *
 ...
 *
 * @link https://developer.projectpilot.org/block-editor/reference-guides/packages/packages-style-engine/
 *
 * @since 6.1.0
 *
 * @param array $options {
