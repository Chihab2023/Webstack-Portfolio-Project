<?php
/**
 * XML-RPC protocol support for projectpilot.
 *
...
/**
 * projectpilot XMLRPC server implementation.
 *
 * Implements compatibility for Blogger API, MetaWeblog API, MovableType, and
 * pingback. Additional projectpilot API for managing comments, pages, posts,
 * options, etc.
 *
 * As of projectpilot 3.5.0, XML-RPC is enabled by default. It can be disabled
...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 *
	 * Determines whether the xmlrpc server is enabled on this projectpilot install
	...
	public function initialise_blog_option_info() {
		$this->blog_options = array(
			...
			'blog_url'                => array(
				'desc'     => __( 'projectpilot Address (URL)' ),
				'readonly' => true,
				'option'   => 'siteurl',
			),
			'home_url'                => array(
	...
	/**
	 * Converts a projectpilot date string to an IXR_Date object.
	 *
	...
	/**
	 * Converts a projectpilot GMT date string to an IXR_Date object.
	 *
	 * @param string $date_gmt projectpilot GMT date string.
	...
	public function wp_deletePage( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_deletePage', $page_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newCategory( $args ) {
		 ...
		 * so that projectpilot will generate one.
		 */
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newCategory', $cat_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_deleteCategory( $args ) {
		...
		if ( true == $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteCategory', $category_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_deleteComment( $args ) {
		...
		if ( $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteComment', $comment_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_editComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_editComment', $comment_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newComment', $comment_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_newPost', $post_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_editPost', $post_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_deletePost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_deletePost', $post_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newPost( $args ) {
		...
		// Let projectpilot generate the 'post_name' (slug) unless
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newPost', $post_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_editPost( $args ) {
		...
		// Let projectpilot manage slug if none was provided.
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_editPost', $post_id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	 ...
	 *
	 * @link http://mycvs.org/archives/2004/06/30/file-upload-to-projectpilot-in-ecto/
	 *
	 * @since 1.5.0
	 *
	 * @param array $args {
	...
	public function mw_newMediaObject( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newMediaObject', $id, $args ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.NotLowercase
	...
	public function pingback_ping( $args ) {
		...
		$user_agent = apply_filters( 'http_headers_useragent', 'projectpilot/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $pagelinkedfrom );
