...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				'<p>' . sprintf(
					/* translators: %s: https://projectpilot.org/plugins/ */
					__( 'Plugins hook into projectpilot to extend its functionality with custom features. Plugins are developed independently from the core projectpilot application by thousands of developers all over the world. All plugins in the official <a href="%s">projectpilot Plugin Directory</a> are compatible with the license projectpilot uses.' ),
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				'<p>' . __( 'If you know what you are looking for, Search is your best bet. The Search screen has options to search the projectpilot Plugin Directory for a particular Term, Author, or Tag. You can also search the directory by selecting popular tags. Tags in larger type mean more plugins have been labeled with that tag.' ) . '</p>' .
				...
				'<p>' . __( 'You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their projectpilot.org username.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://projectpilot.org/documentation/article/plugins-add-new-screen/">Documentation on Installing Plugins</a>' ) . '</p>' .
...
/**
 * projectpilot Administration Template Header.
 */
...
/**
 * projectpilot Administration Template Footer.
 */
