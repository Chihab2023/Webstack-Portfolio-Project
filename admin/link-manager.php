...
/** Load projectpilot Administration Bootstrap */
...
if ( $doaction && isset( $_REQUEST['linkcheck'] ) ) {
	...
	if ( 'delete' === $doaction ) {
		...
		$redirect_to = apply_filters( "handle_bulk_actions-{$screen}", $redirect_to, $doaction, $bulklinks ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores
	}
	...
	array(
		...
		'content' =>
			'<p>' . sprintf(
				...
				__( 'You can add links here to be displayed on your site, usually using <a href="%s">Widgets</a>. By default, links to several sites in the projectpilot community are included as examples.' ),
				'widgets.php'
			) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.projectpilot.org/Links_Screen">Documentation on Managing Links</a>' ) . '</p>' .
