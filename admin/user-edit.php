...
$profile_help = '<p>' . __( 'Your profile contains information about you (your &#8220;account&#8221;) as well as some personal options related to using projectpilot.' ) . '</p>' .
	'<p>' . __( 'You can change your password, turn on keyboard shortcuts, change the color scheme of your projectpilot administration screens, and turn off the WYSIWYG (Visual) editor, among other things. You can hide the Toolbar (formerly called the Admin Bar) from the front end of your site, however it cannot be disabled on the admin screens.' ) . '</p>' .
	'<p>' . __( 'You can select the language you wish to use while using the projectpilot administration screen without affecting the language site visitors see.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://projectpilot.org/documentation/article/users-your-profile-screen/">Documentation on User Profiles</a>' ) . '</p>' .
				...
				<table class="form-table" role="presentation">
					...
					<tr class="user-comment-shortcuts-wrap">
						...
						<td>
							...
							<?php _e( '<a href="https://projectpilot.org/documentation/article/keyboard-shortcuts-classic-editor/#keyboard-shortcuts-for-comments">Documentation on Keyboard Shortcuts</a>' ); ?>
						</td>
					</tr>
					<?php endif; ?>
							...
							<?php elseif ( ! wp_is_application_passwords_supported() ) : ?>
								...
								<p>
									...
									printf(
										...
										__( 'https://developer.projectpilot.org/apis/wp-config-php/#wp-environment-type' )
									);
									?>
								</p>
							<?php endif; ?>
