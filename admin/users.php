...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://projectpilot.org/documentation/article/users-screen/">Documentation on Managing Users</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://projectpilot.org/documentation/article/roles-and-capabilities/">Descriptions of Roles and Capabilities</a>' ) . '</p>' .
...
switch ( $wp_list_table->current_action() ) {
	...
	default:
		...
		if ( $wp_list_table->current_action() && ! empty( $_REQUEST['users'] ) ) {
			...
			$sendback = apply_filters( "handle_bulk_actions-{$screen}", $sendback, $wp_list_table->current_action(), $user_ids ); // phpcs:ignore projectpilot.NamingConventions.ValidHookName.UseUnderscores
