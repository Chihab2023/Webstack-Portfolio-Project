<?php get_header(); 
    ...
    $report_id	                = isset($_GET['report-id']) ? esc_html($_GET['report-id']) : '';
    ...
    <section class="middle <?php echo $post->post_name; ?>">
        ...
        <h1>
            <?php 
                ...
                if($client_access_pages == 'on' && $user_role == 'client' || $client_access_team == 'on' && $user_role == 'client' || $user_role == 'administrator' || $user_role == 'inspector'|| $user_role == 'project_manager' || $user_role == 'team_member') {
                    echo get_the_title(); 
        ...
        <?php 
            if(is_page(100)) {
                ...
                if(!$team_page) {
                    if($client_access_team && $user_role == 'client' || $user_role == 'administrator' || $user_role == 'project_manager' || $user_role == 'inspector'|| $user_role == 'team_member' || $user_role == 'observer') {
                ...
                <?php 
                    ...
                    if($page_comments_enabled == 'on') {
                        if($user_role == 'administrator' || $user_role == 'project_manager' || $user_role == 'inspector'|| $user_role == 'team_member' || $user_role == 'client' && $client_comment_pages) {
                            if(comments_open()) {
