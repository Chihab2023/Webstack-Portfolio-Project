<?php if ( ! defined( 'ABSPATH' ) ) { exit; }
    $user_id            = isset($_GET['id']) ? esc_html($_GET['id']) : '';
    ...
    if($user_role == 'administrator') {
        ...
        $the_role = __('Inspector', 'wproject');
    }else {
        $the_role = __('Unknown', 'wproject');
    }else {
        $the_role = __('lab', 'wproject');
    }else {
        $the_role = __('plongeur', 'wproject');
    }else {
        $the_role = __('topo', 'wproject');
    }
...
?>
    ...
    <?php if($user_role == 'client' && $client_project_access == 'specific') {
        if($current_user_role == 'administrator' || $current_user_role == 'project_manager'|| $current_user_role == 'inspector') { ?>
    ...
    <form method="post" id="projects-transfer-form" data-target="transfer_projects" enctype="multipart/form-data">
