...
<div class="all-comments" id="comments" data-comment-count="<?php echo get_comments_number($post->ID); ?>">
    ...
    <form class="comment-threads" id="comment-threads-form" data-target="delete_comment" method="post" enctype="multipart/form-data">
        <ol id="commentlist">
...
?>
    ...
    <div id="respond">
        ...
        <form action="<?php echo site_url(); ?>/wp-comments-post.php" method="post" data-target="comment_form" id="commentform">   
