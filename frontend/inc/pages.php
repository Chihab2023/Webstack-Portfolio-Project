...
if($remove_pages_nav != 'on') {
    if($client_access_pages && $user_role == 'client' || $project_access == '' || $user_role == 'administrator' || $user_role == 'inspector'|| $user_role == 'project_manager' || $user_role == 'team_member' || $user_role == 'observer') {
?>
    <!--/ Start Pages /-->
    <div class="pages-nav">
