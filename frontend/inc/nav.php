...
?>
<ul class="main-nav">
    <li><a href="<?php echo home_url();?>/"><i data-feather="home"></i><?php _e('Inbox', 'wproject'); ?></a></li>
    <li>
        <?php /* Project manager and Administrator logic */
        if($user_role == 'project_manager' || $user_role == 'team_member'  || $user_role == 'inspector' || $user_role == 'administrator' || $user_role == 'observer') { ?>
    ...
    <?php 
        if($remove_pages_nav != 'on') {
            if($client_access_pages && $user_role == 'client' || $user_role == 'inspector'|| $user_role == 'administrator' || $user_role == 'project_manager' || $user_role == 'team_member' || $user_role == 'observer') { ?>
    ...
    <?php if(!$team_page) {
        if($client_access_team && $user_role == 'client' || $user_role == 'inspector'|| $user_role == 'administrator' || $user_role == 'project_manager' || $user_role == 'team_member' || $user_role == 'observer') { ?>
