    ...
    <?php 
        ...
        if($user_role != 'observer') {
            ...
            if(function_exists('gantt_pro_dashboard')) {
                ...
                if($hide_gantt !='yes' && $user_role == 'client' && $gantt_show_dashboard == 'on' && $client_project_access == 'limited' && empty($print)) {
                    get_template_part('gantt/gantt-limited');
                } else if($hide_gantt !='yes' && $user_role == 'client' && $gantt_show_dashboard == 'on' && $client_project_access == 'unlimited' && empty($print)) {
                    get_template_part('gantt/gantt');
                } else if($hide_gantt !='yes' && $user_role != 'client' && $gantt_show_dashboard == 'on' && empty($print)) {
                    get_template_part('gantt/gantt');
                }
        ...
        <div class="tabby spacer">
            ...
            <ul class="tab-nav">
                ...
                <?php if($user_role == 'administrator' || $user_role == 'project_manager' || $user_role == 'team_member'|| $user_role == 'inspector') { ?>
