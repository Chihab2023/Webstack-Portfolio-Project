...
<ul class="icons">
    ...
    <?php } ?>
        ...
        <?php if($user_role == 'administrator' || $user_role == 'inspector' || $user_role == 'project_manager' || $user_role == 'team_member' || $user_role == 'observer') { ?>
            ...
            <?php if(!wp_is_mobile()) { ?>
            <form id="switch-theme-form" class="switch-theme-form-facade" data-target="change_theme" method="post" enctype="multipart/form-data">
