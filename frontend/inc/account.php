...
?>
<!--/ Start Account /-->
<form class="general-form account-form" method="post" data-target="update_user_details" id="account-form" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <ul>
            ...
            <?php } ?>
            <?php if($user_role == 'project_manager' || $user_role == 'administrator'|| $user_role == 'inspector') { ?>
            <li>
            ...
            <?php if($enable_kanban) {
                if($user_role == 'project_manager' || $user_role == 'administrator' || $user_role == 'inspector') { ?>
                <li>
