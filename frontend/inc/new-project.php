...
$project_name               = isset($_GET['project_name']) ? esc_html($_GET['project_name']) : '';
...
<!--/ Start New Project /-->
<form class="general-form new-project-form" method="post" data-target="add_new_project" id="new-project-form" enctype="multipart/form-data">
    <fieldset>
