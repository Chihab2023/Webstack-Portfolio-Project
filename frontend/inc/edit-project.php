...
?>
    <!--/ Start Edit Project /-->
    <form class="general-form edit-project-form" method="post" data-target="edit_project" id="edit-project-form" enctype="multipart/form-data">
        <fieldset>
    ...
    <div class="no-access">
        <?php echo $the_avatar; ?>
        <p>
            <?php printf( __(  'Oops! This project is managed by <a href="%1$s">%2$s</a>.', 'wproject' ), esc_attr($project_owner_profile), esc_attr($project_owner_name) ); ?>
        </p>
    </div>
    <?php } ?>
...
?>
    <li><a href="<?php echo home_url(); ?>/project/<?php echo esc_attr($project->slug); ?>"><i data-feather="folder"></i><?php _e('Go to project', 'wproject'); ?></a></li>
    <li><a href="<?php echo home_url(); ?>/report/?report-id=<?php echo esc_attr($project_id); ?>"><i data-feather="bar-chart-2"></i><?php _e('Report', 'wproject'); ?></a></li>
