	...
	<div class="wproject-wrap wrap">
		...
		<?php settings_fields( 'wproject_settings' ); ?>
			...
			<div class="settings-nav">
				<ul>
					<li data="home" <?php if($section == 'home' || empty($section)) { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/home.svg" /><?php _e( 'Home', 'wproject' ); ?></li>

                    <?php do_action('wproject_admin_nav_start') ?>

					<li data="presentation" id="presentation" <?php if($section == 'presentation') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/presentation.svg" /><?php _e( 'Presentation', 'wproject' ); ?></li>
					<li data="permissions" id="permissions" <?php if($section == 'permissions') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/permissions.svg" /><?php _e( 'Permissions', 'wproject' ); ?></li>
					<li data="gantt" id="gantt" <?php if($section == 'gantt') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/gantt.svg" /><?php _e( 'Gantt Chart', 'wproject' ); ?></li>
					<li data="kanban" id="kanban" <?php if($section == 'kanban') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/kanban.svg" /><?php _e( 'Kanban Board', 'wproject' ); ?></li>
					<li data="time" id="time" <?php if($section == 'time') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/time.svg" /><?php _e( 'Time & Costs', 'wproject' ); ?></li>
                    <li data="labels" id="labels" <?php if($section == 'labels') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/labels.svg" /><?php _e( 'Context Labels', 'wproject' ); ?></li>
					<li data="notifications" id="notifications" <?php if($section == 'notifications') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/notifications.svg" /><?php _e( 'Notifications', 'wproject' ); ?></li>
					<li data="comments" id="comments" <?php if($section == 'comments') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/comments.svg" /><?php _e( 'Comments', 'wproject' ); ?></li>
					<li data="print" id="print" <?php if($section == 'print') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/print.svg" /><?php _e( 'Printing', 'wproject' ); ?></li>

                    <?php do_action('wproject_admin_nav_end') ?>

					<li data="other" id="other" <?php if($section == 'other') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/other.svg" /><?php _e( 'Other Settings', 'wproject' ); ?></li>
					<li data="maintenance" id="maintenance" <?php if($section == 'maintenance') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/maintenance.svg" /><?php _e( 'Maintenance', 'wproject' ); ?></li>
					
					<li data="credits" id="credits" <?php if($section == 'credits') { echo 'class="selected"'; } ?>><img src="<?php echo get_template_directory_uri();?>/images/admin/credits.svg" /><?php _e( 'Assists', 'wproject' ); ?></li>
				</ul>
				<script>
			...
			<div class="settings-pane">
				...
				<div class="settings-div home">
					...
					<?php if($section == 'home' || $section || $page == 'wproject-settings') {
...
function add_project_manager_role() {
	add_role( 'project_manager', __( 'Project manager', 'wproject' ),
		array(
			'level_9'                => true,
			'level_8'                => true,
			'level_7'                => true,
...
function add_observer_role() {
	remove_role('observer'); add_role( 'observer', __( 'Observer', 'wproject' ),
		array(
			'read' => true,
		)
	);
}
add_action('init', 'add_observer_role');


function add_operator_role() {
	add_role( 'operator', __( 'Operator', 'wproject' ),
		array(
			'level_9'                => true,
			'level_8'                => true,
			'level_7'                => true,
...
add_action('init', 'add_operator_role');

function add_team_member_role() {
	add_role( 'team_member', __( 'Team member', 'wproject' ),
		array(
			'level_9'                => true,
			'level_8'                => true,
			'level_7'                => true,
